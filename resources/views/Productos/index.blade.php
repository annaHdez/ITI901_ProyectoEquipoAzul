            ...
            <div class="card-body " style="min-width: 100%;">                    
                <div class="contiainer d-inine-flex">
                    ...
                    <div class="d-inline-flex">
                        {{ Form::open(array('url' => route('Productos.destroy', $producto->id), 'class' => 'pull-right')) }}
                        {{ Form::hidden('_method', 'DELETE') }}
                        {{ Form::submit('Borrar', array('class' => 'btn btn-danger','onclick'=>"return confirm('Eliminar Producto')")) }}
                        {{ Form::close() }}
                    </div>
