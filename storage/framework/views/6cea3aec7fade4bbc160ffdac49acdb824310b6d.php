        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
            ...
            <link href="https://fonts.googleapis.com/css2?family=Dancing+Script&display=swap" rel="stylesheet">                
                ...
                <ul class="navbar-nav mr-auto" style="margin-left: -67%;">
                    <img src="<?php echo e(asset('icons/log.png')); ?>" alt="" style="width: 60px; height: 60px; padding-bottom: 10px ">
                </ul>                             
               ...
               <!-- <form class="form-inline my-2 my-lg-0">
                    <a href="<?php echo e(URL::to('Login')); ?>" type="button" class="btn btn-outline-success my-2 my-sm-0 text-success"
