...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><h3><?php echo e(__('Inicio de Sesión')); ?></h3></div>
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('login')); ?>">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Correo de Usuario')); ?></label>
...
<?php echo $__env->make('layout.header.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DAW_ITI901_HernandezRomero\ITI901_ProyectoEquipoAzul\resources\views/auth/login.blade.php ENDPATH**/ ?>